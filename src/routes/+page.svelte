...
<div class="flex w-full flex-col gap-3">
	...
	<!-- about this concept/ysws -->
	<div class="flex w-full flex-col rounded-lg">
		<div class="flex-1 rounded-lg bg-black/25 p-4 sm:p-6">
			<h2 class="mb-4 text-2xl font-semibold">What is this thing?</h2>
			<p>
	...
	<div class="flex w-full flex-col rounded-lg">
		<div class="flex-1 rounded-lg bg-black/25 p-4 sm:p-6">
			...
			<div class="mt-4 flex flex-col gap-4 lg:flex-row lg:justify-around lg:gap-6">
				{#each featuredItems as item (item.name)}
					<div
						class="w-full rounded-2xl border border-white/25 bg-black/25 p-3 backdrop-blur-md transition-colors hover:bg-black/40 lg:w-64"
					>
		...
		<div class="flex-1 rounded-lg bg-black/25 p-4 sm:p-6">
			...
			<div class="mt-4 flex flex-row flex-wrap justify-around gap-6">
				{@render card(
					...
					'/',
					'basis-full lg:basis-[calc((100%-3rem)/3)]'
				)}
				<!-- {@render card(
					'HackaTime',
