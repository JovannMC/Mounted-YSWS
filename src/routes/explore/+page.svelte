<script lang="ts">
	...
	const totalHours = $derived(projects.reduce((total, project) => total + project.hours, 0));
</script>
			...
			>
				...
				<div class="space-y-3 p-4">
					...
					<div class="flex flex-wrap items-center gap-2 text-sm text-white/65">
						<span class="rounded-md bg-white/15 px-2 py-1">by {project.author.username}</span>
